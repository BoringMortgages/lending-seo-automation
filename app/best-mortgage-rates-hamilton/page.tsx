...
function HamiltonMortgageCalculator({ onOpenContactForm }: { onOpenContactForm: () => void }) {
  const [purchasePrice, setPurchasePrice] = React.useState(778000);
  const [downPayment, setDownPayment] = React.useState(155600);
...
export default function HamiltonMortgageRates() {
  ...
  const hamiltonInsights = [
    ...
    },
    {
      title: "Market Growth",
      value: "Tech Hub",
      description: "McMaster innovation corridor",
      icon: "📈"
    },  
    {
  ...
  const handleLockRateSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          to: 'hello@mortgagewithford.ca',
          subject: `New Rate Lock Request - Hamilton`,
  ...
  const hamiltonPrograms = [
    ...
    {
      program: "Hamilton Housing Strategy",
      description: "Municipal affordable housing initiatives",
      eligibility: "Various income thresholds"
    },
    {
    ...
    <div className="min-h-screen bg-white" style={{backgroundColor: '#FAFAFA'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="flex flex-col items-center text-center mb-16">
            ...
            <p className="text-xl mb-8 leading-relaxed max-w-3xl" style={{color: '#264653'}}>
              Compare current Hamilton mortgage rates with Steel City expertise. Affordable housing opportunities 
              and growing tech market potential. <strong>No bank lineups required.</strong>
            </p>
            ...
            <div className="grid grid-cols-2 gap-6 mb-8 max-w-md">
              ...
              <div className="text-center p-4 backdrop-blur-sm rounded-xl border shadow-professional hover:shadow-lg transition-all duration-300" style={{backgroundColor: '#F4F4F4', borderColor: '#2A9D8F'}}>
                <div className="text-2xl font-bold" style={{color: '#2A9D8F'}}>$778K</div>
              ...
              <div className="mt-10 grid md:grid-cols-2 gap-8">
                <div className="p-5 bg-white/80 backdrop-blur-sm rounded-xl border border-slate-200/30 shadow-sm">
                  <p className="text-sm text-muted mb-2">
                    <strong>*Payment calculation:</strong> $622,400 mortgage (80% of Hamilton average), 25-year amortization.
                  </p>
      ...
      <section className="py-20 relative overflow-hidden" style={{background: 'linear-gradient(to bottom right, #FAFAFA, #F4F4F4)'}}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <HamiltonMortgageCalculator onOpenContactForm={() => setIsContactFormOpen(true)} />
        </div>
      </section>
      ...
      <section className="py-16" style={{background: 'linear-gradient(to bottom right, #F4F4F4, #FAFAFA)'}}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg" style={{color: '#264653'}}>
              Free tools for Hamilton homebuyers who value accuracy
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Calculate monthly payments for Hamilton's affordable market
              </p>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                See how much home you can afford in Hamilton's market
              </p>
              <div className="text-emerald-600 font-medium">
                Check Hamilton affordability →
              </div>
            </Link>
            ...
            >
              ...
              <p className="text-gray-600 mb-4">
                Calculate home equity access for Hamilton homeowners
              </p>
          ...
          <div className="space-y-6">
            <div className="backdrop-blur-sm p-8 rounded-xl shadow-professional border hover:shadow-lg transition-all duration-300" style={{backgroundColor: '#F4F4F4', borderColor: '#2A9D8F'}}>
              ...
              <p style={{color: '#264653'}}>
                Yes! Hamilton offers strong growth potential with tech companies moving from Toronto, McMaster University driving innovation, and GO Transit improvements making GTA commutes easier. Average home prices are 30% less than Toronto.
              </p>
            </div>
            ...
            <div className="backdrop-blur-sm p-8 rounded-xl shadow-professional border hover:shadow-lg transition-all duration-300" style={{backgroundColor: '#F4F4F4', borderColor: '#2A9D8F'}}>
              ...
              <p style={{color: '#264653'}}>
                For Hamilton's average home price of $778,000, the minimum down payment is $38,900 (5% on first $500K, plus 10% on the remaining $278,000). This requires CMHC insurance which adds to your monthly payment.
              </p>
            </div>
            ...
            <div className="backdrop-blur-sm p-8 rounded-xl shadow-professional border hover:shadow-lg transition-all duration-300" style={{backgroundColor: '#F4F4F4', borderColor: '#2A9D8F'}}>
              ...
              <p className="text-gray-600 mb-3">
                While no city-specific programs exist, Hamilton buyers benefit from:
              </p>
              <div className="bg-blue-50 border-l-4 border-blue-400 p-3 mt-3">
                <p className="text-blue-800 text-sm">
                  <strong>Provincial Programs:</strong> First-time buyer incentives, land transfer tax rebates up to $8,475, and CMHC insurance for homes under $1.5M with lower down payments.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 grain-texture mb-20 lg:mb-0 relative overflow-hidden" style={{background: 'linear-gradient(to bottom right, #264653, #2A9D8F)'}}>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-xl mb-8" style={{color: '#F4F4F4'}}>
            ...
            connect with <strong>Andreina Ford</strong> - Licensed Mortgage Agent Level 2, BRX Mortgage #13463, specializing in Hamilton's growing market.
          </p>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link href="/best-mortgage-rates-hamilton" className="hover:text-boring-light-gray text-boring-bright-green">Hamilton</Link></li>
              </ul>
            </div>
            <div>
