        ...
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-3 mb-4">
              ...
              <h3 className="text-lg font-semibold">{CONTACT_CONFIG.business.name}</h3>
            </div>
            ...
            <p className="text-xs" style={{color: '#264653'}}>
              <strong>{CONTACT_CONFIG.business.agentName}</strong><br/>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><a href={CONTACT_CONFIG.consultationUrl} target="_blank" rel="noopener noreferrer" className="hover:text-white">{CONTACT_CONFIG.cta.consultation}</a></li>
              <li><a href={`mailto:${CONTACT_CONFIG.email}?subject=Mortgage questions`} className="hover:text-white">{CONTACT_CONFIG.cta.email}</a></li>
              <li><a href={CONTACT_CONFIG.websiteUrl} target="_blank" rel="noopener noreferrer" className="hover:text-white">About Us</a></li>
              <li><a href={CONTACT_CONFIG.homeUrl} target="_blank" rel="noopener noreferrer" className="hover:text-white">Home</a></li>
            </ul>
          </div>
        </div>
